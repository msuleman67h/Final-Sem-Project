...
int main() {
	int id, quantity[100] = { 12, 10, 40, 4, 32, 10, 20, 20, 10, 5 },
			rate[100] = { 80, 20, 30, 300, 80, 20, 100, 20, 120, 150 };
	char name[100][100] = { "BIRYANI", "COKE", "JUICE", "PIZZA", "APPLE",
			"TISSUE BOX", "MINERAL WATER", "SOAP", "REGISTER", "BURGER" },
			fake[100];
